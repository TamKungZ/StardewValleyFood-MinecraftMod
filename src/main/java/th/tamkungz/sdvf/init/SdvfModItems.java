...
public class SdvfModItems {
    public static final Map<String, Item> FOOD_ITEMS = new LinkedHashMap<>();
    ...
    private static void registerFoodItem(String name, int nutrition, float saturation, String tooltip, boolean executeProcedure) {
        Item item = new BaseFoodItem(nutrition, saturation, tooltip, executeProcedure);
        FOOD_ITEMS.put(name, item);
        Registry.register(Registries.ITEM, new Identifier(SdvfMod.MODID, name), item);
    }
}